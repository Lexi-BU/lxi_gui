...
def create_config_file(default_vals=False):
    ...
    if not default_vals:
        if not os.path.isfile("luigi.cfg"):
            ...
            gui_config.set("sci_plot_options", "cut_status", "False")
            gui_config.set("sci_plot_options", "curve_fit_status", "False")
            gui_config.set("sci_plot_options", "lin_corr_status", "True")
