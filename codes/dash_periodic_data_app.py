...
@app.callback(Output("trend-plot", "figure"), Input("key-dropdown", "value"))
def update_plot(selected_key):
    ...
    try:
        ...
        shifted_data = (
            df_filtered_new[selected_key].values - linear_trend
        )  # Shift original data by the linear trend
        ...
        fig.update_layout(
            ...
            yaxis2=dict(title="Original Data", overlaying="y", side="right"),
