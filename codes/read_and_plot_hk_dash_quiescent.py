...
if read_data:
    ...
    available_columns = list(df.columns)
    default_columns = [available_columns[3]]
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div([
            ...
            dcc.Input(id="hv_threshold_low", type="number", value=0, style={"marginRight": "10px", "width": "50px", "textAlign": "center", "backgroundColor": "#121212", "color": "white", "border": "1px solid white", "borderRadius": "5px", "padding": "5px", "marginBottom": "10px", "marginTop": "10px"}),
            html.Label("HV Threshold High:", style={"color": "white"}),
            dcc.Input(id="hv_threshold_high", type="number", value=2100, style={"marginRight": "10px", "width": "50px", "textAlign": "center", "backgroundColor": "#121212", "color": "white", "border": "1px solid white", "borderRadius": "5px", "padding": "5px", "marginBottom": "10px", "marginTop": "10px"}),
            dcc.Checklist(
...
def update_plot(selected_operations, selected_columns, filtering_length, hv_threshold_low, hv_threshold_high, hv_threshold_check, save_fig_check, log_scale_check):
    ...
    for idx, col in enumerate(selected_columns):
        ...
        for i, op in enumerate(selected_operations):
            ...
            common_hover_data = {"event_number": False, "operation_number": False, "DateTime": False, f"{col}_smooth": False, col: True, "Date": False}  # Common hover data
            specific_hover_data = {col: True, "event_number": False, f"{col}_smooth": False, "DateTime": False, "operation_number": False, "Date": False}  # Only show column-specific data
